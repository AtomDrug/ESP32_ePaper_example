...
*/
//------------------------------------------------------
extern void EPD_drawPixel(int16_t x, int16_t y, color_t color);
...
*/
//------------------------------------------
extern color_t EPD_readPixel(int16_t x, int16_t y);
...
*/
//---------------------------------------------------------------------
extern void EPD_drawFastVLine(int16_t x, int16_t y, int16_t h, color_t color);
...
*/
//---------------------------------------------------------------------
extern void EPD_drawFastHLine(int16_t x, int16_t y, int16_t w, color_t color);
...
*/
//-------------------------------------------------------------------------------
extern void EPD_drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1, color_t color);
...
*/
//-----------------------------------------------------------------------------------------------------------
extern void EPD_drawLineByAngle(uint16_t x, uint16_t y, uint16_t start, uint16_t len, uint16_t angle, color_t color);
...
*/
//---------------------------------------------------------------------------
extern void EPD_fillRect(int16_t x, int16_t y, int16_t w, int16_t h, color_t color);
...
*/
//------------------------------------------------------------------------------
extern void EPD_drawRect(uint16_t x1,uint16_t y1,uint16_t w,uint16_t h, color_t color);
...
*/
//----------------------------------------------------------------------------------------------
extern void EPD_drawRoundRect(int16_t x, int16_t y, uint16_t w, uint16_t h, uint16_t r, color_t color);
...
*/
//----------------------------------------------------------------------------------------------
extern void EPD_fillRoundRect(int16_t x, int16_t y, uint16_t w, uint16_t h, uint16_t r, color_t color);
...
*/
//--------------------------------
extern void EPD_fillScreen(color_t color);
...
*/
//---------------------------------
extern void EPD_fillWindow(color_t color);
...
*/
//-----------------------------------------------------------------------------------------------------------------
extern void EPD_drawTriangle(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, color_t color);
...
*/
//-----------------------------------------------------------------------------------------------------------------
extern void EPD_fillTriangle(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, color_t color);
...
*/
//-------------------------------------------------------------------
extern void EPD_drawCircle(int16_t x, int16_t y, int radius, color_t color);
...
*/
//-------------------------------------------------------------------
extern void EPD_fillCircle(int16_t x, int16_t y, int radius, color_t color);
...
*/
//------------------------------------------------------------------------------------------------------
extern void EPD_drawEllipse(uint16_t x0, uint16_t y0, uint16_t rx, uint16_t ry, color_t color, uint8_t option);
...
*/
//------------------------------------------------------------------------------------------------------
extern void EPD_fillEllipse(uint16_t x0, uint16_t y0, uint16_t rx, uint16_t ry, color_t color, uint8_t option);
...
*/
//----------------------------------------------------------------------------------------------------------------------------
extern void EPD_drawArc(uint16_t cx, uint16_t cy, uint16_t r, uint16_t th, float start, float end, color_t color, color_t fillcolor);
...
*/
//--------------------------------------------------------------------------------------------------------------
extern void EPD_drawPolygon(int cx, int cy, int sides, int diameter, color_t color, color_t fill, int deg, uint8_t th);


//--------------------------------------------------------------------------------------
//void EPD_drawStar(int cx, int cy, int diameter, color_t color, bool fill, float factor);

extern void EPD_setFont(uint8_t font);

extern void getMaxWidthHeight();
 ...
 */
//-------------------------------------------
extern int EPD_getfontsize(int *width, int* height);
 ...
 */
//-------------------------------------
extern void EPD_print(char *st, int x, int y);
 ...
 */
//-------------------------------------------------------------------------
extern void set_7seg_font_atrib(uint8_t l, uint8_t w, int outline, color_t color);
 ...
 */
//----------------------------------------------------------------------
extern void EPD_setclipwin(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2);
 ...
 */
//------------------------
extern void EPD_restoreClipWin();
 ...
 */
//--------------------------------
extern int EPD_getStringWidth(char* str);


/*
 * Fills the rectangle occupied by string with current background color
 */
extern void EPD_clearStringRect(int x, int y, char *str);

/*
 * Get all font's characters to buffer
 */
extern void getFontCharacters(uint8_t *buf);
 ...
 *
 */
int EPD_jpg_image(int x, int y, uint8_t scale, uint8_t *buf, int size);
